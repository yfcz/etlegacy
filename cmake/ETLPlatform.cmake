...
if(UNIX)
	...
	elseif(APPLE)
		...
		if(BUILD_CLIENT)
			set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -framework Quartz -framework AudioUnit -framework Carbon -framework CoreAudio -framework ForceFeedback -liconv -lbz2")
		endif()
		set(LIB_SUFFIX "_mac")
